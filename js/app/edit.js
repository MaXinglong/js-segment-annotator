  ...
  function (Layer, Annotator, util) {
    ...
    function createSidebar(params, data, annotator) {
      var container = document.createElement("div"),
        ...
        labelPicker2 = createLabelPicker2(params, data, annotator),
      ...
      spacer0.className = "edit-sidebar-spacer";
      ...
      container.appendChild(spacer0);
      container.appendChild(labelPicker2);
      container.appendChild(spacer1);
    ...
    // Create the label picker button.
    function createLabelPicker2(params, data, annotator) {
      var container = document.createElement("div");
      container.className = "edit-sidebar-label-picker";

      var labelButton = createLabelButton(data, 'segline', data.labels.length, annotator);
      container.appendChild(labelButton);
